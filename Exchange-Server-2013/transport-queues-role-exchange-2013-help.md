---
title: '传输队列角色: Exchange 2013 Help'
TOCTitle: 传输队列角色
ms:assetid: f663005a-4cb0-4c52-9c95-58681fc5eaab
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876955(v=EXCHG.150)
ms:contentKeyID: 50491994
ms.date: 05/21/2018
...
通过 `Transport Queues` 管理角色，管理员可以管理单个传输服务器上的邮件队列。
