---
title: 'Exchange Server 证书角色: Exchange 2013 Help'
TOCTitle: Exchange Server 证书角色
ms:assetid: fffec840-6c7d-4958-905e-edc4bc060d52
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876963(v=EXCHG.150)
ms:contentKeyID: 50492067
ms.date: 05/21/2018
...
通过 `Exchange Server Certificates` 管理角色，管理员可以在各个服务器上创建、导入、导出和管理 Exchange 服务器证书。
