---
title: '地址列表角色: Exchange 2013 Help'
TOCTitle: 地址列表角色
ms:assetid: 31143e30-16f5-45f5-b9a6-a39e6aa831d9
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876867(v=EXCHG.150)
ms:contentKeyID: 50490273
ms.date: 05/21/2018
...
`Address Lists` 管理角色使管理员能够在组织中创建、修改、查看和删除地址列表、全局地址列表 (GAL)、通讯簿策略和脱机地址列表 (OAB)。
