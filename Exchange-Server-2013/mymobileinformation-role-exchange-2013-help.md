...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Ff461935(v=EXCHG.150)
ms:contentKeyID: 50491309
ms.date: 05/21/2018
...
`MyMobileInformation`管理角色使各个用户可以查看和修改他们的移动电话和寻呼机号码。这是在[MyContactInformation 角色](mycontactinformation-role-exchange-2013-help.md)父角色中创建自定义角色。
