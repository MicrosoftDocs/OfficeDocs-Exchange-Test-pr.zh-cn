---
title: '重置密码角色: Exchange 2013 Help'
TOCTitle: 重置密码角色
ms:assetid: d80101f1-7e3d-4a61-b93a-23da23e95e93
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/JJ657499(v=EXCHG.150)
ms:contentKeyID: 50491646
ms.date: 05/21/2018
...
重置密码管理角色可让各个用户重置自己的密码，并可让管理员重置组织中用户的密码。
