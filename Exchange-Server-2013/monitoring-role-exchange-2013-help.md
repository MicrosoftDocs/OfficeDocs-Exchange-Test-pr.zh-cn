---
title: '监视角色: Exchange 2013 Help'
TOCTitle: 监视角色
ms:assetid: ba4cb787-8e17-4565-bccd-74e846c06a4f
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876933(v=EXCHG.150)
ms:contentKeyID: 50491517
ms.date: 05/21/2018
...
监控管理角色使管理员能够监视Exchange服务和组件的组织中的可用性。此外可以监视应用程序用来收集有关运行Exchange的服务器的状态信息的服务帐户使用此角色。
