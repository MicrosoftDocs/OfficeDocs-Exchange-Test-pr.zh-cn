---
title: '邮件跟踪角色: Exchange 2013 Help'
TOCTitle: 邮件跟踪角色
ms:assetid: 21f18ccd-9b7d-461b-b77c-443d15696d79
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876858(v=EXCHG.150)
ms:contentKeyID: 50490063
ms.date: 01/11/2018
...
`Message Tracking` 管理角色使管理员能够在组织中跟踪邮件。
