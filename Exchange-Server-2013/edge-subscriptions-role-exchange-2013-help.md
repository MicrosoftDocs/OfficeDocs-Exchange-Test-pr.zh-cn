---
title: '边缘订阅角色: Exchange 2013 Help'
TOCTitle: 边缘订阅角色
ms:assetid: 7de1a663-96fb-4fb5-898a-effa82653597
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876912(v=EXCHG.150)
ms:contentKeyID: 50490904
ms.date: 05/21/2018
...
使用 `Edge Subscriptions` 管理角色，管理员可以管理组织中 Microsoft Exchange Server 2010 边缘传输服务器与 Microsoft Exchange Server 2013 邮箱服务器之间的边缘同步和订阅配置。
