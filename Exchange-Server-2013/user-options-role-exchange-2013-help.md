---
title: '用户选项角色: Exchange 2013 Help'
TOCTitle: 用户选项角色
ms:assetid: fb4d58f5-cc62-4ce8-b2e4-c3cc91795a12
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876960(v=EXCHG.150)
ms:contentKeyID: 50492036
ms.date: 05/21/2018
...
通过 `User Options` 管理角色，管理员可以查看组织中的用户的 Outlook Web App 选项。此角色可用于帮助诊断配置问题。
