---
title: '数据库可用性组角色: Exchange 2013 Help'
TOCTitle: 数据库可用性组角色
ms:assetid: 0b3e0f7a-21e5-4209-8d5b-b63c6b9de3cc
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876847(v=EXCHG.150)
ms:contentKeyID: 50489894
ms.date: 05/21/2018
...
`Database Availability Groups` 管理角色使管理员能够在组织中管理数据库可用性组。直接或间接被分配此角色的管理员是负责组织中高可用性配置的最高级别管理员。
