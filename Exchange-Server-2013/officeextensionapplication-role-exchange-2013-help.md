...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/JJ657479(v=EXCHG.150)
ms:contentKeyID: 50491268
ms.date: 05/21/2018
...
`OfficeExtensionApplication` 管理角色使 Microsoft Office 扩展应用程序可以访问用户邮箱。
