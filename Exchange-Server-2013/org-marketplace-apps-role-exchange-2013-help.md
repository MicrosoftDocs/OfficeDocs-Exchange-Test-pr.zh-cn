---
title: '组织市场应用角色: Exchange 2013 Help'
TOCTitle: 组织市场应用角色
ms:assetid: 137ee328-0bad-4911-a7bf-82da7678f246
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/JJ673043(v=EXCHG.150)
ms:contentKeyID: 50489945
ms.date: 05/21/2018
...
组织市场应用程序管理角色让管理员能够查看和修改组织的应用程序，并添加来自 Microsoft Office 商店的应用程序。
