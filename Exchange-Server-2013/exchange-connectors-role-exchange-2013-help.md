---
title: 'Exchange 连接器角色: Exchange 2013 Help'
TOCTitle: Exchange 连接器角色
ms:assetid: 73f98c82-bde0-443d-9bcf-274047e84e15
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876908(v=EXCHG.150)
ms:contentKeyID: 50490916
ms.date: 05/21/2018
...
`Exchange Connectors` 管理角色使管理员能够创建、修改、查看并删除传递代理连接器。

此角色不能用于管理发送和接收连接器。若要管理发送和接收连接器，请使用发送连接器和接收连接器角色。有关详细信息，请参阅：
