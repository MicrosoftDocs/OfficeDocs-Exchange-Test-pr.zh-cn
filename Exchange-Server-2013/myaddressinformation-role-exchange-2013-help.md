...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Ff461936(v=EXCHG.150)
ms:contentKeyID: 50491314
ms.date: 05/21/2018
...
`MyAddressInformation`管理角色使各个用户可以查看和修改其街道地址和工作电话和传真号码。这是在[MyContactInformation 角色](mycontactinformation-role-exchange-2013-help.md)父角色中创建自定义角色。
