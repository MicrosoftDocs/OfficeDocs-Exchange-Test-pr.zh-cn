---
title: '数据库副本角色: Exchange 2013 Help'
TOCTitle: 数据库副本角色
ms:assetid: 71a95f5b-1f75-4ae9-9ee9-515c3a19d394
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876905(v=EXCHG.150)
ms:contentKeyID: 50490826
ms.date: 05/21/2018
...
`Database Copies` 管理角色使管理员能够在各个服务器上添加、删除、挂起、恢复、查看和更新数据库副本。
...
此角色附带的 **Set-MailboxDatabaseCopy** cmdlet 和 **Remove-MailboxDatabaseCopy** cmdlet，要求您要配置或删除的数据库必须在数据库作用域内，并且该数据库必须驻留在服务器作用域之内的服务器上。有关作用域的详细信息，请参阅[了解管理角色作用域](understanding-management-role-scopes-exchange-2013-help.md)。
