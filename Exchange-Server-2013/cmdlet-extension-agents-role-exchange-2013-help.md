---
title: 'cmdlet 扩展代理角色: Exchange 2013 Help'
TOCTitle: cmdlet 扩展代理角色
ms:assetid: 20f9f7c2-a8e5-468e-b1a8-c87c562a2be7
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876857(v=EXCHG.150)
ms:contentKeyID: 50490043
ms.date: 05/21/2018
...
`Cmdlet Extension Agents` 管理角色使管理员能够在组织中启用、禁用和设置 cmdlet 扩展代理的优先级。
