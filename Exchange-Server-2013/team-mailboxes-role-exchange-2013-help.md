---
title: '团队邮箱角色: Exchange 2013 Help'
TOCTitle: 团队邮箱角色
ms:assetid: b4591082-c4af-41bf-bbb1-ed2b931e62fb
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/JJ657485(v=EXCHG.150)
ms:contentKeyID: 50491423
ms.date: 05/21/2018
...
`Team Mailboxes`管理角色，管理员可以定义一个或多个网站邮箱资源调配策略和管理网站在组织中的邮箱。分配了此角色的管理员可以管理他们自己的网站邮箱。
