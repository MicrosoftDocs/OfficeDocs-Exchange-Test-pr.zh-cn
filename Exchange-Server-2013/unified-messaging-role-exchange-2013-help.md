---
title: '统一消息角色: Exchange 2013 Help'
TOCTitle: 统一消息角色
ms:assetid: bf24aa04-5843-4cf3-83e7-3a5fa7bd3522
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876935(v=EXCHG.150)
ms:contentKeyID: 50491446
ms.date: 05/21/2018
...
`Unified Messaging` 角色使管理员能够管理组织中的统一消息 (UM) 服务。

此角色不能让您管理特定 UM 的邮箱配置或 UM 提示。若要管理特定 UM 的邮箱配置，使用`UM Mailboxes `角色关联的角色。管理 UM 提示，使用`UM Prompts`角色相关联的角色。有关详细信息，请参阅 ︰
