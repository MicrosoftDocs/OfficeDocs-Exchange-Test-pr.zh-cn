---
title: '组织传输设置角色: Exchange 2013 Help'
TOCTitle: 组织传输设置角色
ms:assetid: ff4d032e-1b97-4a9d-b479-9b0d61832221
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876961(v=EXCHG.150)
ms:contentKeyID: 50492062
ms.date: 05/21/2018
...
通过 `Organization Transport Settings` 管理角色，管理员可以管理组织范围的传输设置，如系统邮件、Active Directory 站点配置和整个 Exchange 组织的传输配置设置。

使用此角色无法创建或管理发送或接收连接器、队列、安全机制、代理、远程和接受域或规则。若要创建或管理每个传输功能，您必须分配有下列一个或多个角色：
