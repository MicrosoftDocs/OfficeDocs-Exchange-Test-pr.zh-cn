---
title: '组织客户端访问角色: Exchange 2013 Help'
TOCTitle: 组织客户端访问角色
ms:assetid: ff84799a-b79c-498d-b797-7675a4afb1eb
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876962(v=EXCHG.150)
ms:contentKeyID: 50492064
ms.date: 05/21/2018
...
通过 `Organization Client Access` 管理角色，管理员可以管理组织中的客户端访问服务器设置。
