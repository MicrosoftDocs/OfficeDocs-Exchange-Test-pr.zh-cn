---
title: '安全组创建和成员身份角色: Exchange 2013 Help'
TOCTitle: 安全组创建和成员身份角色
ms:assetid: 257eb517-339f-4895-9e08-f772408a41cf
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876860(v=EXCHG.150)
ms:contentKeyID: 50490082
ms.date: 05/21/2018
...
`Security Group Creation and Membership` 管理角色使管理员能够在组织中创建并管理通用安全组 (USG) 及其成员身份。
...
有关详细信息，请参阅[了解拆分权限](understanding-split-permissions-exchange-2013-help.md)。
