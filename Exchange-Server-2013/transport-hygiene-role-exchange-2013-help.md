---
title: '传输清洁角色: Exchange 2013 Help'
TOCTitle: 传输清洁角色
ms:assetid: 629792e4-7a8f-4447-b031-1c7d7c994b8a
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876893(v=EXCHG.150)
ms:contentKeyID: 50490685
ms.date: 05/21/2018
...
`Transport Hygiene` 管理角色使管理员能够管理组织中的反垃圾邮件和反恶意软件功能。
