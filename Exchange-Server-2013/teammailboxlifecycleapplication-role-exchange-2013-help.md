...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/JJ673057(v=EXCHG.150)
ms:contentKeyID: 50490390
ms.date: 05/21/2018
...
`TeamMailboxLifecycleApplication` 管理角色使合作伙伴应用程序可以更新站点邮箱的生命周期状态。
