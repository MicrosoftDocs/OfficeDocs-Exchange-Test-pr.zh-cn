---
title: 'Exchange 服务器角色: Exchange 2013 Help'
TOCTitle: Exchange 服务器角色
ms:assetid: 5a626746-8d23-409c-a604-7e565c429990
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876887(v=EXCHG.150)
ms:contentKeyID: 50490628
ms.date: 01/11/2018
...
`Exchange Servers` 管理角色使管理员能够在各自的服务器上执行下列操作：

  - 添加和删除数据库可用性组以及配置数据库副本

  - 启用、禁用和配置统一消息服务

  - 修改邮箱和客户端访问服务器上的传输配置

  - 启用和禁用客户端访问服务器上的 Microsoft Outlook Anywhere

  - 修改邮箱和客户端访问服务器配置

  - 修改客户端访问服务器上的 Outlook Anywhere 配置
