---
title: '无作用域的角色管理角色: Exchange 2013 Help'
TOCTitle: 无作用域的角色管理角色
ms:assetid: d11eb843-64c9-4968-bfd5-9a8d94903058
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876943(v=EXCHG.150)
ms:contentKeyID: 50491598
ms.date: 05/21/2018
...
通过 `Unscoped Role Management` 管理角色，管理员可以在组织中创建和管理未确定范围的顶级管理角色。
