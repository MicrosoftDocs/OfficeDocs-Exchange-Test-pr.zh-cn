---
title: 'Exchange 虚拟目录角色: Exchange 2013 Help'
TOCTitle: Exchange 虚拟目录角色
ms:assetid: d10896e9-3574-42bb-9090-61f3abc33005
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876942(v=EXCHG.150)
ms:contentKeyID: 50491719
ms.date: 05/21/2018
...
通过 `Exchange Virtual Directories` 管理角色，管理员可以管理 Microsoft Office Outlook Web App、Microsoft ActiveSync、脱机通讯簿 (OAB)、自动发现、Windows PowerShell 以及各服务器上的 Web 管理界面虚拟目录。
