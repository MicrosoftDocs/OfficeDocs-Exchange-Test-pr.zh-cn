---
title: '电子邮件地址策略角色: Exchange 2013 Help'
TOCTitle: 电子邮件地址策略角色
ms:assetid: d272e672-81ea-417c-b5d6-76a5efd5c036
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876944(v=EXCHG.150)
ms:contentKeyID: 50491600
ms.date: 05/21/2018
...
通过 `E-Mail Address Policies` 管理角色，管理员可以管理组织中的电子邮件地址策略。
