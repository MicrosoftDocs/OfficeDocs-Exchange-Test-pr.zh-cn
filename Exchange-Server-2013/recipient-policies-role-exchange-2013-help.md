---
title: '收件人策略角色: Exchange 2013 Help'
TOCTitle: 收件人策略角色
ms:assetid: 81c76e5d-bc57-4326-93ca-5e673c9aa85e
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876916(v=EXCHG.150)
ms:contentKeyID: 50491085
ms.date: 05/21/2018
...
`Recipient Policies` 管理角色使管理员能够管理组织中的收件人策略，例如限制策略、Microsoft Office Outlook Web App 邮箱策略和移动设备策略。
