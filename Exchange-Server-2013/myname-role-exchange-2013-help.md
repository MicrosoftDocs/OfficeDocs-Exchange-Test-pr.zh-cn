---
title: 'MyName 角色: Exchange 2013 Help'
TOCTitle: MyName 角色
ms:assetid: 6c8320d3-7a71-4975-b8b3-c1b1b52dd7df
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Ff461931(v=EXCHG.150)
ms:contentKeyID: 50490778
ms.date: 05/21/2018
...
`MyName`管理角色使各个用户可以查看和修改其全名和他们备注字段。这是在[MyProfileInformation 角色](myprofileinformation-role-exchange-2013-help.md)父角色中创建自定义角色。
...
有关内置和自定义管理角色和管理角色条目的详细信息，请参阅[了解管理角色](understanding-management-roles-exchange-2013-help.md)。
...
<tbody>
<tr class="odd">
<td>您还可以将此管理角色分配给一个角色组、USG 或直接分配给用户。但是，以用户为中心的角色在与角色分配策略一起使用时最有效。</td>
</tr>
</tbody>
</table>
