---
title: '远程域和接受的域角色: Exchange 2013 Help'
TOCTitle: 远程域和接受的域角色
ms:assetid: 340c7546-5236-4743-a2b3-3c2363f3da1d
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876869(v=EXCHG.150)
ms:contentKeyID: 50490180
ms.date: 05/21/2018
...
`Remote and Accepted Domains` 管理角色使管理员能够在组织中管理远程域和接受域。
