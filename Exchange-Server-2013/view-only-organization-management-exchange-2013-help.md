---
title: '仅查看组织管理: Exchange 2013 Help'
TOCTitle: 仅查看组织管理
ms:assetid: c514c6d0-0157-4c52-9ec6-441d9a30f3df
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd351130(v=EXCHG.150)
ms:contentKeyID: 50491494
ms.date: 01/11/2018
...
仅查看组织管理 管理角色组是组成 Microsoft Exchange Server 2013 中基于角色的访问控制 (RBAC) 权限模型的多个内置角色组之一。角色组会分配给一个或多个管理角色，这些管理角色拥有执行一组给定任务所需的权限。角色组的成员会获得访问角色组所分配的管理角色的权限。有关角色组的详细信息，请参阅[了解管理角色组](understanding-management-role-groups-exchange-2013-help.md)。

作为 View-Only Organization Management 角色组成员的管理员可以查看 Exchange 组织中任何对象的属性。

此角色等同于 Microsoft Exchange Server 2007 中的 Exchange View-Only Administrators 角色。
