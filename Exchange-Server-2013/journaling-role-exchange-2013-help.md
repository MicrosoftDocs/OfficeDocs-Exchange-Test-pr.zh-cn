---
title: '日记角色: Exchange 2013 Help'
TOCTitle: 日记角色
ms:assetid: 64608dbe-d4b4-444e-a7df-bc536c4da202
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876894(v=EXCHG.150)
ms:contentKeyID: 50490722
ms.date: 05/21/2018
...
`Journaling` 管理角色使管理员能够创建、修改、启用、禁用、查看和删除组织中的日记规则。
