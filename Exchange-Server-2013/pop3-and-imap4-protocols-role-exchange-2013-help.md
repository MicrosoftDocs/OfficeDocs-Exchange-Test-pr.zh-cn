---
title: 'POP3 和 IMAP4 协议角色: Exchange 2013 Help'
TOCTitle: POP3 和 IMAP4 协议角色
ms:assetid: 67dd66e0-3cca-4f87-8165-4918519b39b6
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876898(v=EXCHG.150)
ms:contentKeyID: 50490833
ms.date: 05/21/2018
...
`POP3 and IMAP4 Protocols` 管理角色使管理员能够管理各个服务器上的 POP3 和 IMAP4 配置，如身份验证和连接设置。
