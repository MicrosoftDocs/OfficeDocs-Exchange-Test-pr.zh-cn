---
title: 'UM 提示语角色: Exchange 2013 Help'
TOCTitle: UM 提示语角色
ms:assetid: 262928e8-b938-404f-b941-a636f4d18169
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876861(v=EXCHG.150)
ms:contentKeyID: 50490220
ms.date: 05/21/2018
...
`UM Prompts` 管理角色使管理员能够创建和管理组织中的自定义统一消息语音提示。
