...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/JJ657498(v=EXCHG.150)
ms:contentKeyID: 50491624
ms.date: 05/21/2018
...
`WorkloadManagement`管理角色使管理员能够管理工作负载管理策略。管理员可以配置资源健康定义，工作负载分类，然后启用或禁用工作负载管理。只应在 Microsoft 客户服务和支持的指导下进行更改。
