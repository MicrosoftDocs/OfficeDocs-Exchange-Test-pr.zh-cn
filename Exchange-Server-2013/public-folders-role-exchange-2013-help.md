---
title: '公用文件夹角色: Exchange 2013 Help'
TOCTitle: 公用文件夹角色
ms:assetid: b858f04c-ac0b-495f-9193-8b9645781f73
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876930(v=EXCHG.150)
ms:contentKeyID: 50491415
ms.date: 05/21/2018
...
`Public Folders ` 管理角色使管理员能够管理组织中的公用文件夹。

此角色不能使您能够管理是否已启用邮件的公用文件夹。若要启用或禁用公用文件夹时，必须分配与`Mail Enabled Public Folders `角色相关联的角色。有关详细信息，请参阅[启用邮件的公用文件夹角色](mail-enabled-public-folders-role-exchange-2013-help.md)。
