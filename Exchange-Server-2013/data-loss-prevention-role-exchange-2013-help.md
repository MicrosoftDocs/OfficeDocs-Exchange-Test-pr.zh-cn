---
title: '数据丢失防护角色: Exchange 2013 Help'
TOCTitle: 数据丢失防护角色
ms:assetid: 026d0e48-f4da-416e-a00d-794bd3b38c5c
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/JJ673034(v=EXCHG.150)
ms:contentKeyID: 50489836
ms.date: 05/21/2018
...
数据丢失预防管理角色使管理员可以创建和管理数据丢失预防 (DLP) 策略以及其中的规则（这些策略和规则可以影响整个组织的邮件传递）。而且，此角色使管理员可以配置在电子邮件客户端中出现的策略提示并管理 DLP 策略违反报告。通过此 DLP 角色还可以访问 Microsoft Exchange 传输规则。有关 Exchange 中的传输规则的详细信息，请参阅下列主题：

  - [传输规则角色](transport-rules-role-exchange-2013-help.md)

  - [传输规则新增内容](what-s-new-for-transport-rules-exchange-2013-help.md)
