---
title: '组织的自定义应用角色: Exchange 2013 Help'
TOCTitle: 组织的自定义应用角色
ms:assetid: ab2aac13-f783-43e6-a369-75cce1d4943f
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/JJ657482(v=EXCHG.150)
ms:contentKeyID: 50491364
ms.date: 05/21/2018
...
组织自定义应用程序管理角色使管理员能够查看和修改其组织的应用程序以及从文件或 URL 中添加自定义应用程序。
