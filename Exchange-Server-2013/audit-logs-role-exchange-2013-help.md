---
title: '审核日志角色: Exchange 2013 Help'
TOCTitle: 审核日志角色
ms:assetid: 36a7d375-76f8-441c-9da1-8a50dbd062f1
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876870(v=EXCHG.150)
ms:contentKeyID: 50490309
ms.date: 05/21/2018
...
`Audit Logs` 管理角色使管理员能够在组织中配置管理员审核日志。
