---
title: '邮箱导入导出角色: Exchange 2013 Help'
TOCTitle: 邮箱导入导出角色
ms:assetid: d7cdce7a-6c46-4750-b237-d1c1773e8d28
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Ee633482(v=EXCHG.150)
ms:contentKeyID: 50491749
ms.date: 01/11/2018
...
通过 `Mailbox Import Export` 管理角色，管理员可以导入和导出邮箱内容，以及清除邮箱中不需要的内容。
