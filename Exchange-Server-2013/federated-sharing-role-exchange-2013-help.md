---
title: '联合共享角色: Exchange 2013 Help'
TOCTitle: 联合共享角色
ms:assetid: 3d81048c-24bf-447d-a1ee-7fb2974a51fd
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876876(v=EXCHG.150)
ms:contentKeyID: 50490397
ms.date: 05/21/2018
...
`Federated Sharing` 管理角色使管理员能够管理组织中的跨林和跨组织共享。
