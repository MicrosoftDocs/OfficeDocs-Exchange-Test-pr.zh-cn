...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876906(v=EXCHG.150)
ms:contentKeyID: 50490825
ms.date: 05/21/2018
...
`Role Management` 管理角色使管理员能够管理管理角色组、角色分配策略和管理角色、以及组织中的角色条目、分配和作用域。

获得此角色的用户可以覆盖按属性管理的角色组，配置任何角色组，并向任何角色组中添加成员或从中删除成员。
