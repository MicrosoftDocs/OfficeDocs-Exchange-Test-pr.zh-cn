...
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Mt846639(v=EXCHG.150)
ms:contentKeyID: 74520320
ms.date: 04/23/2018
...
![适用于 iOS 和 Android 的 Outlook 中的混合新式验证的体系结构关系图](images/Mt846639.20a7e963-916d-47e0-bffb-4d86c4777bea(EXCHG.150).png "适用于 iOS 和 Android 的 Outlook 中的混合新式验证的体系结构关系图")
...
![混合新式验证中的身份验证流](images/Mt846639.d6e20ddb-cf8e-4154-8a17-95657ef696d1(EXCHG.150).png "混合新式验证中的身份验证流")
...
![为混合新式验证配置的适用于 iOS 和 Android 的 Outlook 帐户示例](images/Mt846639.79887a65-e5e1-4501-a274-008393dbb6c9(EXCHG.150).png "为混合新式验证配置的适用于 iOS 和 Android 的 Outlook 帐户示例")
...
![用户应在成功设置混合新式验证过程中看到的对话框](images/Mt846639.2e17cce9-d4b7-4842-9c5a-d92f055dbf56(EXCHG.150).png "用户应在成功设置混合新式验证过程中看到的对话框")
...
![指示向用户显示了传统基本身份验证 Exchange ActiveSync 体验的对话框](images/Mt846639.32bb9907-9cae-4200-9cbf-8091da2eac83(EXCHG.150).png "指示向用户显示了传统基本身份验证 Exchange ActiveSync 体验的对话框")
...
![用户在自动检测未能发现其本地邮箱配置时看到的对话框](images/Mt846639.b481cab4-e5b0-4f52-b931-7c4e059453f1(EXCHG.150).png "用户在自动检测未能发现其本地邮箱配置时看到的对话框")
