---
title: '灾难恢复角色: Exchange 2013 Help'
TOCTitle: 灾难恢复角色
ms:assetid: 6dd321a8-7621-44be-b3c5-76535e006653
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876902(v=EXCHG.150)
ms:contentKeyID: 50490792
ms.date: 05/21/2018
...
`Disaster Recovery` 管理角色使管理员能够在组织中还原邮箱和邮箱数据库、创建邮箱数据库以及执行数据库可用性组的数据中心切换。
