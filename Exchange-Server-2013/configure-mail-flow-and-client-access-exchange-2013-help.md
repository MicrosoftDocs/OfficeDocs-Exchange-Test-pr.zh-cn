...
2.  选择邮箱，然后在收件人详细信息窗格中确认“用户邮箱”字段已设置为<em>\<别名\></em>@<em>\<新接受域\></em>。例如，david@contoso.com。
...
3.  或者，您可以新建一个邮箱并通过下列操作确认向该邮箱提供具有新接受域的电子邮件地址：
    ...
    3.  选择新邮箱，然后在收件人详细信息窗格中确认“用户邮箱”字段已设置为<em>\<别名\></em>@<em>\<新接受域\></em>。例如，david@contoso.com。
