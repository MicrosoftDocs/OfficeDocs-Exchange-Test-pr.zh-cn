---
title: '传输规则角色: Exchange 2013 Help'
TOCTitle: 传输规则角色
ms:assetid: 53c5b1a5-e989-4373-ac70-7db16000c645
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876885(v=EXCHG.150)
ms:contentKeyID: 50490562
ms.date: 05/21/2018
...
`Transport Rules` 管理角色使管理员能够管理组织中的传输规则。
