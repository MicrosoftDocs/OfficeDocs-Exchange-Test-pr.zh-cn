---
title: '接收连接器角色: Exchange 2013 Help'
TOCTitle: 接收连接器角色
ms:assetid: a7c5a086-5066-4ece-9b22-cc1048d2f2bc
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876927(v=EXCHG.150)
ms:contentKeyID: 50491346
ms.date: 01/11/2018
...
`Receive Connectors` 管理角色使管理员能够管理传输接收连接器配置，例如每台服务器上的大小限制。
