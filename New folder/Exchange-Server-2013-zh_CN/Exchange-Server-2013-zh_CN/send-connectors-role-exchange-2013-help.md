---
title: '发送连接器角色: Exchange 2013 Help'
TOCTitle: 发送连接器角色
ms:assetid: 8021e279-2b74-469e-aa6d-d0197f34ba6c
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876913(v=EXCHG.150)
ms:contentKeyID: 50491082
ms.date: 05/21/2018
...
`Send Connectors` 管理角色使管理员能够管理组织中的传输发送连接器。
