---
title: '通讯组角色: Exchange 2013 Help'
TOCTitle: 通讯组角色
ms:assetid: 0c3667b6-529b-4bb2-85bf-e24fae82d082
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/Dd876848(v=EXCHG.150)
ms:contentKeyID: 50489981
ms.date: 05/21/2018
...
`Distribution Groups` 管理角色使管理员能够创建、修改、查看和删除通讯组，并能够添加或删除组织中的通讯组成员。
