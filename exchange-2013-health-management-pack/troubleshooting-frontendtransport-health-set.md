---
title: FrontendTransport 运行状况设置故障排除
TOCTitle: FrontendTransport 运行状况设置故障排除
ms:assetid: 397fdb57-32d2-4cf8-9243-b95dc17031bb
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/ms.exch.scom.frontendtransport(v=EXCHG.150)
ms:contentKeyID: 54652329
ms.date: 10/08/2015
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# FrontendTransport 运行状况设置故障排除
