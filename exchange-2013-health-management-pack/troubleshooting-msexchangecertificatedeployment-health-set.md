---
title: MSExchangeCertificateDeployment 运行状况设置故障排除
TOCTitle: MSExchangeCertificateDeployment 运行状况设置故障排除
ms:assetid: 27410f8f-25bd-4bde-b4d5-5597c15d9ec7
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/ms.exch.scom.msexchangecertificatedeployment(v=EXCHG.150)
ms:contentKeyID: 54652325
ms.date: 10/08/2015
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# MSExchangeCertificateDeployment 运行状况设置故障排除
