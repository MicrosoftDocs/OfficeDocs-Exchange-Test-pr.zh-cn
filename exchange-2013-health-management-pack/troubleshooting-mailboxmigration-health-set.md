---
title: MailboxMigration 运行状况设置故障排除
TOCTitle: MailboxMigration 运行状况设置故障排除
ms:assetid: 4219fe4b-6757-409a-9065-d81d07d144b2
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/ms.exch.scom.mailboxmigration(v=EXCHG.150)
ms:contentKeyID: 54652331
ms.date: 10/08/2015
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# MailboxMigration 运行状况设置故障排除
