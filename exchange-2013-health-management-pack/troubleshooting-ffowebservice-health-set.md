---
title: FfoWebService 运行状况设置故障排除
TOCTitle: FfoWebService 运行状况设置故障排除
ms:assetid: 21a23319-dbac-4b82-a420-d9f728bb9965
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/ms.exch.scom.ffowebservice(v=EXCHG.150)
ms:contentKeyID: 54652323
ms.date: 10/08/2015
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# FfoWebService 运行状况设置故障排除
