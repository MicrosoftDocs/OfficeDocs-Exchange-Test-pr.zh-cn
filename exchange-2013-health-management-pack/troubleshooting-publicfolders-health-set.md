---
title: PublicFolders 运行状况设置故障排除
TOCTitle: PublicFolders 运行状况设置故障排除
ms:assetid: 79666be3-250d-4db0-961d-8351866d722c
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/ms.exch.scom.publicfolders(v=EXCHG.150)
ms:contentKeyID: 54652338
ms.date: 10/08/2015
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# PublicFolders 运行状况设置故障排除
