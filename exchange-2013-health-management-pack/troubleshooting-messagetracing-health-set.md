---
title: MessageTracing 运行状况设置故障排除
TOCTitle: MessageTracing 运行状况设置故障排除
ms:assetid: 58a53525-9479-4377-9a2e-641bac6f3ad3
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/ms.exch.scom.messagetracing(v=EXCHG.150)
ms:contentKeyID: 54652335
ms.date: 10/08/2015
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# MessageTracing 运行状况设置故障排除
