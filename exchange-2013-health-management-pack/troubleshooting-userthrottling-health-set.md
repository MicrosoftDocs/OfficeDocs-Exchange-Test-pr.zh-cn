---
title: UserThrottling 运行状况设置故障排除
TOCTitle: UserThrottling 运行状况设置故障排除
ms:assetid: 8d48d06a-9d96-4905-84db-bb84398d0a54
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/ms.exch.scom.userthrottling(v=EXCHG.150)
ms:contentKeyID: 54652342
ms.date: 10/08/2015
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# UserThrottling 运行状况设置故障排除
