---
title: FfoQuarantine 运行状况设置故障排除
TOCTitle: FfoQuarantine 运行状况设置故障排除
ms:assetid: 7e0573d8-271a-4058-90c6-b4875b3b8456
ms:mtpsurl: https://technet.microsoft.com/zh-cn/library/ms.exch.scom.ffoquarantine(v=EXCHG.150)
ms:contentKeyID: 54652340
ms.date: 10/08/2015
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# FfoQuarantine 运行状况设置故障排除
